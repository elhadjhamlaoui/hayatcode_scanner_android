...
public class UserLocalStore {
    ...
    public void storeUserData(User user) {
        ...
        userLocalDatabaseEditor.putString("organization", user.getOrganization());
    ...
    public User getLoggedInUser() {
        ...
        String organization = userLocalDatabase.getString("organization", "");
        ...
        User user = new User(familyName, firstName, email, birthDate, gender, photo, "",
                deliveryAddress, phone, blood, organization, pin, nationalId, items, contacts, medInfos, records);
        return user;
    }
}
